...
def close_browser_tab():
    ...
    try:
        time.sleep(1)  # Allows time to switch focus
...
genai.configure(api_key="AIzaSyAjyd2SWljVm5CguR0naoEPPQzG6izVkIE") 
...
def voice_loop():
        ...
        while True:
            ...
            if "what is your name" in query:
                speak("My name is Jarvis, i am your personal AI assistant")

            elif "hey jarvis" in query:
                speak("hello Jarvis here, how may i assist you")
            
            elif "how are you" in query:
                speak("am absolutely fine, how about you?")

            elif "i'm great" in query or "i'm good" in query or "i'm ok" in query:
                speak("it's good to know that you are fine .")

            elif "i'm under the weather" in query:
                speak("sorry thats bad to hear, kindly visit the nearest clinic for medical help")

            elif "not feeling ok" in query or "i'm not fine" in query: 
                speak("what's seems to be the problem")

            elif "i'm feeling sad" in query:
                speak("don't be sad, you are so amazing, you should not feel that way") 
